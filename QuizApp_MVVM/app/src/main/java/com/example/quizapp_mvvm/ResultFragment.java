...
public class ResultFragment extends Fragment {
    ...
    private TextView resultCorrect, resultWrong, resultMissed;

    private TextView resultPercent;
    private ProgressBar resultProgess;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        resultMissed = view.findViewById(R.id.result_misses_text);
        resultPercent = view.findViewById(R.id.result_percent);
        resultProgess = view.findViewById(R.id.result_progess);
    ...
    private void loadResult() {
        ...
        firebaseFirestore.collection("QuizList")
                ...
                .document(currentUID).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    Long miss = result.getLong("unanswered");

                    // calculate progess
                    Long total = correct + wrong + miss;
                    Long percent = (correct * 100) / total;

                    resultPercent.setText(percent.toString() + "%");
                    resultProgess.setProgress(percent.intValue());
